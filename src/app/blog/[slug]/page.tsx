...
export async function generateMetadata({ params }: BlogPostPageProps) {
  ...
  return {
    ...
    openGraph: {
      title: post.title,
      description: post.description,
      url: `https://vibewithadam.matthewsteinberger.com/blog/${slug}`,
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const jsonLd = {
    ...
    author: { '@type': 'Person', name: post.author, url: 'https://vibewithadam.matthewsteinberger.com/story' },
    publisher: { '@type': 'Organization', name: 'Adam Matthew Steinberger LLC' },
    mainEntityOfPage: `https://vibewithadam.matthewsteinberger.com/blog/${slug}`,
    keywords: post.tags.join(', '),
  };
