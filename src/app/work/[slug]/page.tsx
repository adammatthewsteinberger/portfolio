...
export async function generateMetadata({ params }: ProjectPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${project.title} | Adam Matthew Steinberger — Work`,
      description: project.description,
      url: `https://vibe.with.adam.matthewsteinberger.com/work/${slug}`,
    },
  };
}
...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  const jsonLd = {
    ...
    name: project.title,
    description: project.description,
    creator: { '@type': 'Person', name: 'Adam Matthew Steinberger', url: 'https://vibe.with.adam.matthewsteinberger.com/story' },
